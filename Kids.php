				...
				$query = $conn->query("SELECT *FROM product WHERE category='Kids' ORDER BY product_id DESC") or die (mysqli_error());
					...
					while($fetch = $query->fetch_array())
						...
						if($qty <= 5){
							...
							echo "<center>";
							echo "<a href='details.php?id=".$fetch['product_id']."'><img class='img-polaroid' src='img/kidsshoes/".$fetch['product_image']."' height = '300px' width = '300px'></a>";
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:17px;"> Copyright &copy; Online Shoe Store Inc. 2025 Brought To You by <b>Prem & Jeet</b></a></p>
		</div>
