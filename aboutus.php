...
<div id="container">
		...
		<div id="content">
			...
			<br />
				<legend><h3>Vision</h3></legend>
					<h4 style="text-indent:60px;">Shoe Buzz, the company that inspire, motivate, and give determination to the sports enthusiast.</h4>
			<br />
	...
	<div id="footer">
		...
		<!--	<label style="font-size:17px;"> Copyrght &copy; </label> -->
			<p style="font-size:17px;">Copyrght &copy; Shoe Buzz Inc. 2025 Brought To You by <b>Prem & Jeet</b></p>
		</div>
